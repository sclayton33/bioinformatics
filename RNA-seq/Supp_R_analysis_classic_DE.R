# Change directory from terminal before executing this script
# cd /home/user/bioinformatics/ref_genome/test_data/align_output/de/ballgown/ref_only/

# You may need to also give the script execution permission
# chmod +x Supp_R_analysis_classic_DE.R

# Run from terminal via the command
# ./Supp_R_analysis_classic_DE.R
...
pdf(file="/home/user/bioinformatics/ref_genome/test_data/align_output/de/ballgown/ref_only/Tutorial_Part3_Supplementary_R_output.pdf")
...
working_dir = "/home/user/bioinformatics/ref_genome/test_data/align_output/de/ballgown/ref_only"
setwd(working_dir)
